...
class RateDataCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $columns = [
            ...
            'analyser_cloc_per_loc' => 'asc',
            'sniffer_errors' => 'desc',
            'sniffer_errors_per_loc' => 'desc',
            'analyser_forks' => 'asc',
        ...
        foreach($reader->getRecords() as $record) {
            $writer->insertOne([
                    ...
                    Percentiles::classifyScoreAsc($record['analyser_cloc_per_loc'], $columnPercentile['analyser_cloc_per_loc']),
                    Percentiles::classifyScoreDesc($record['sniffer_errors'], $columnPercentile['sniffer_errors']),
                    Percentiles::classifyScoreDesc($record['sniffer_errors_per_loc'], $columnPercentile['sniffer_errors_per_loc']),
